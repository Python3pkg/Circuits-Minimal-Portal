# -*- coding: utf-8 -*-
#
# Circuits Minimal Portal documentation build configuration file, created by
...
release = circuits_minpor.__version__
...
htmlhelp_basename = 'CircuitsMinimalPortaldoc'
